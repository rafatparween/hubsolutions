            ...
            <div className="max-w-7xl mx-auto p-8 space-y-8 bg-gray-100 text-gray-800">
                ...
                <section>
                    ...
                    <ul className="list-disc list-inside text-lg space-y-2">
                        ...
                        <li>Print Hub Solutions reserves the right to update or modify these terms at any time without notice.</li>
                ...
                <section>
                    ...
                    <p className="text-lg">
                        This website may contain links to external websites that are not provided, maintained, or affiliated with Print Hub Solutions.
                        We do not guarantee the accuracy, relevance, timeliness, or completeness of any information on these external sites.
                        Print Hub Solutions is not responsible for the content, privacy practices, or policies of any third-party websites linked from our platform.
